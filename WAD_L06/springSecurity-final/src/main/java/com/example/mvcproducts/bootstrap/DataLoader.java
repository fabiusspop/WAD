...
public class DataLoader implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    List<Product> productList = List.of(
            new Product("Car", ProductType.HARDWARE, "Nice car",134000, "download.jpg" ),
            new Product("Computer", ProductType.HARDWARE, "Lenovo",2500, "download.jpg" ),
            new Product("Office", ProductType.SOFTWARE, "Office",670, "download.jpg" ),
            new Product("Windows", ProductType.SOFTWARE, "win",500, "download.jpg" ),
            new Product("Cake", ProductType.HARDWARE, "Sweet",20, "download.jpg" )
    );
